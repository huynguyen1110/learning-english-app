...
project_path = "E:\DO_AN_TN\code-folder\learning-english-app\hand-wirting-recognition"
...
sentences_txt_path = os.path.join(project_path, "Datasets", "metadata", "sentences.txt")
sentences_folder_path = os.path.join(project_path,"Datasets", "dataset")
